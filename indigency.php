...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO indigency_applications (firstName, middleName, lastName, address, birthdate, purpose, householdMembers, monthlyIncome, application_date, status, age) VALUES (?, ?, ?, ?, ?, ?, ?, ?, NOW(), 'Pending', ?)";
...
<body>
    <h2>Barangay Indigency Application Form</h2>
    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
        <div class="form-container">
            ...
            <label for="purpose">Purpose of Indigency:</label>
            ...
            <input type="number" id="householdMembers" name="householdMembers" value="<?php echo htmlspecialchars($householdMembers); ?>" required>

            <label for="monthlyIncome">Monthly Income (PHP):</label>
            <input type="number" id="monthlyIncome" name="monthlyIncome" value="<?php echo htmlspecialchars($monthlyIncome); ?>" required>
